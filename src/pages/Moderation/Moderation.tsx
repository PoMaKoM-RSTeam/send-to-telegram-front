    ...
    <div className="page-moderation">
      <header className="header">
        ...
        <div className="setting-wrapper">
          <button className="btn-add-item" type="button">
            +
          </button>
      ...
      <div className="filter-wrapper">
        <div className="filter-list">
          <button className="btn-filter-list" type="button">
            Применить фильтр
          </button>
          <button className="btn-filter-list" type="button">
            Изменить вид столбцов
          </button>
      ...
      <div className="filter-item">
        <button className="btn-filter-item" type="button">
          Пользователь &#9650;
        </button>
        <button className="btn-filter-item" type="button">
          Юзернейм &#9650;
      ...
      <div className="item-list-wrapper">
        <ul>
          <li className="list-group-item">
            ...
            <a href="google.com" className="userName">
              @PoMa_KoM
            </a>
            <span className="category">Moderator</span>
            <span className="count-message">5</span>
            <button className="btn-item-setting" type="button">
              <i>&#10247;</i>
            </button>
          </li>
          <li className="list-group-item">
